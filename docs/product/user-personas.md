...
- **Visível para quem:** a busca de jogadores é **pública** — qualquer visitante, sem necessidade de login, pode buscar jogadores com `is_discoverable = true`. O botão "Convidar" só aparece para usuários autenticados que sejam donos de time.
